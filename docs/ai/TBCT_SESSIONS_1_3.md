...
- Content: src/patient/sessions/s01/spec.ts (nodes: mandatory-opening, situation-thought-distinction, three-person-example, first-candidate, second-candidate, ... — source lines 18-222 of the TBCT source manual).
