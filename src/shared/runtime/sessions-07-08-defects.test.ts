...
import { matchEnumChoice, parseDeterministicPromptInput } from "@/shared/runtime/runtime-deterministic-input";
import { composeCrpPlanSummary, resolveStaticText as resolveS07StaticText } from "@/patient/sessions/s07/messages";
import { composeTrialClosingSummary, resolveStaticText as resolveS08StaticText } from "@/patient/sessions/s08/messages";
import { stepSpecificGuidanceFor } from "@/shared/dialogue-agent/dialogue-contract-compiler";
import { courtroomRoleNameForNode } from "@/shared/api/runtime-execution-api";
import { computeDefaultPathNodeIds, computeMissingFields } from "@/shared/runtime/testing/simulated-patient-runner";
import { defaultFallbackPatientText, isPatientSafeFallbackText, normalizeRuntimePromptItem, promptRequiresPatientInput, resolvePromptLocaleText } from "@/shared/runtime/runtime-release-normalizer";
