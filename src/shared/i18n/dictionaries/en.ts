const en = {
  ...
  patientShell: {
    ...
    helpDescription: "We're here whenever you need us.",
    helpButton: "Get help",
  ...
  patientPortal: {
    ...
    description: "See your progress across each session in one place.",
    stats: { total: "Total", active: "Active", waiting: "Waiting", complete: "Complete" },
    statHelpers: { total: "All sessions you started", active: "Sessions in progress", waiting: "Sessions waiting for your answer", complete: "Completed sessions" },
    noSessions: { title: "No sessions yet", description: "Your progress will appear here after you start a session." },
    listHeading: "My session history",
    listDescription: "Review sessions you have completed or are still working on.",
    localPreviewNotice: "Local screen preview. Example records are not saved.",
  ...
  patientJourney: {
    ...
    progress: "{completed} of 8 completed",
    completed: "Completed",
    in_progress: "In progress",
    next: "Up next",
    upcoming: "Upcoming",
    current: "It’s time for {title}.",
    currentSession: "It’s time for Session {number}",
    nextStep: "Your next step",
    ready: "You can continue whenever you feel ready.",
    continue: "Continue",
    starting: "Starting...",
    records: "My session history",
    recordsHelp: "Review sessions you have completed or are still working on.",
    homework: "Review homework",
    homeworkHelp: "Find activities from your sessions in one place.",
  },
  patientNewSession: {
    title: "Start Session",
  ...
  homework: {
    ...
    s01: {
      title: "My Distortion Examples",
      eyebrow: "Session 1 follow-up",
      introTitle: "This week",
      introBody: "Keep the list of cognitive distortions nearby. Whenever a thought like this comes up, write a short example in the 'My examples' column of the pattern it fits. You pick the pattern yourself -- there's no wrong answer. We'll look at them together next time.",
      total: "Examples so far: {count}",
      tableLabel: "The 15 cognitive distortions and my examples",
      colNumber: "No.",
      colName: "Distortion",
      colDefinition: "Definition",
      colExample: "Example",
      colMine: "My examples",
      addMine: "Add my example",
      textLabel: "My example",
      textPlaceholder: "When it happened and what went through your mind",
      dateLabel: "Date",
      save: "Save",
      cancel: "Cancel",
    ...
    s02: {
      ...
      introTitle: "This week",
      introBody: "Keep the same fifteen patterns in view this week. Whenever one of those thoughts comes up, write a short example in the 'My example' box, and at the end of the week pick how often each pattern came up and how strongly you believed it at the time. The score works itself out.",
      rounds: "Rounds recorded so far: {count}",
      colMine: "My example",
      colFrequency: "How often",
      colIntensity: "How strongly",
      examplePlaceholder: "When it happened and what went through your mind",
      freq0: "Not at all",
      freq1: "1-2 days",
      freq2: "3-5 days",
      freq3: "6-7 days",
      int0: "Not at all",
      int1: "A little (up to 30%)",
      int2: "Quite (31-70%)",
      int3: "Very much (over 70%)",
      scored: "{count} of {of} patterns scored",
      total: "Total",
      finish: "I've scored them all",
      hiddenUntilDone: "Your earlier scores stay hidden until all fifteen are scored, so pick as if for the first time.",
      saveFailed: "Couldn't save. Please try again in a moment.",
      trendTitle: "How it has changed",
      trendHint: "The score from the session is the starting point, then each week since. A higher or lower total does not mean better or worse.",
      baseline: "In session",
      again: "Score again",
    },
    s03: {
