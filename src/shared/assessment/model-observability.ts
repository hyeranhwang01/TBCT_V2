export type ModelPurpose = "input_assessment" | "field_extraction" | "safety_classification" | "patient_reflection" | "dialogue_agent" | "repair" | "approved_static" | "deterministic_parse" | "distortion_candidates" | "s01_scene" | "summary_fidelity";
