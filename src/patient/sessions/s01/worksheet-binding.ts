...
export const TBCT_S01_BINDINGS: WorksheetBinding[] = [
  ...
  // S01 redesign (note2026_09_12_s01_redesign): problems and goals now open
  // the session. The full two-worksheet layout lands in Phase 3.
  { sessionDefinitionId: "tbct-s01", canonicalFieldKey: "s01Problems", worksheetFieldKey: "s01Problems", visualElementId: "list-problems", valueType: "text_list", participantOwned: true, assistantMustNotSupply: true, confirmationRequired: false, displayMode: "list", label: "My difficulties", labelKo: "나의 어려움", sourceSection: "Problems and Goals", displayOrder: 17 },
];
